...
p5.prototype.registerMethod('init', function p5playInit() {
	...
	this.P5Play = class {
		...
		constructor() {
			...
			this._renderStats = {};
			/*
			 * Ledgers for collisionManager callback functions.
			 *
			 * Doing this:
	...
	this.Sprite = class {
		 ...
		 *
		 * Custom collisionManager event handling can be done by using this function
	...
	$.Sprite.prototype.__step = $.Group.prototype.__step = function () {
		// for each type of collisionManager and overlap event
		let a = this;
		let b;
		for (let event in eventTypes) {
	...
	let errMsgs = {
		...
		Sprite: {
			...
			collide: {
				...
				1: 'The collisionManager callback has to be a function.',
				2: "You're trying to check for an collisionManager with a sprite or group that doesn't exist!"
			},
			overlap: {
